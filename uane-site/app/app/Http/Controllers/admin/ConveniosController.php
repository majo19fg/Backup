...
class ConveniosController extends Controller
{
    ...
    public function update(Request $request, UaneConvenio $convenio)
    {
        ...
        $convenio->alcance_Municipal                = $request->get('alcance_Municipal');
        $convenio->alcance_Estatal                  = $request->get('alcance_Estatal');
        $convenio->alcance_Nacional                 = $request->get('alcance_Nacional');
