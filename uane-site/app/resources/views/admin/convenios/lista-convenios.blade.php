                    ...
                    <table id="datatable1" class="table display responsive nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="wd-10p"><a href="/laravel/public/multi/images/{{ $convenio->documento }}"><i class="far fa-file tx-22 tx-danger lh-0 valign-middle"></i><span class="pd-l-5">{{ $convenio->nombre_documento }}</span></a></td>
