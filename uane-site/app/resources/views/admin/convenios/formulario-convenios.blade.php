    ...
    <div class="br-section-wrapper">
        <div class="row mg-t-10">
            <div class="col-xl-10 offset-1">
                <form action="{{ route('convenios.formulario.guardar') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-layout form-layout-4">
                        ...
                        <div class="alert alert-success alert-bordered" role="alert">
                            ...
                            <div class="d-sm-flex align-items-center justify-content-start">
                                ...
                                <div class="mg-t-20 mg-sm-t-0">
                                    <h5 class="mg-b-2 tx-success">Convenio guardado exitosamente.</h5>
                                    <p class="mg-b-0 tx-gray">¡El convenio se ha guardado exitosamente!</p>
                                </div>
                            </div>
                            <!-- d-flex -->
                        </div>
                        ...
                        <div class="row mg-t-10">
                            ...
                            <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                <input type="text" value="{{ old('empresa') }}" name="empresa" class="form-control"
                                    placeholder="">
                            </div>
                        </div>
                        {{-- Giro --}}
                        ...
                        <div class="row mg-t-20">
                            <label class="col-sm-4 form-control-label">Correo de Contacto <span
                                    class="tx-danger">*</span></label>
                            <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                <input type="text" value="{{ old('correo_contacto') }}" name="correo_contacto"
                                    class="form-control" placeholder="">
                            </div>
                        </div>
                        ...
                        <div class="row mg-t-10">
                            ...
                            <div class="col-lg-4 mg-t-20 mg-lg-t-0">
                                ...
                                <select class="form-control select2 col-lg-12" name="beca_para_bach"
                                    ...
                                    @for ($i = 0; $i < 101; $i++) <option value="{{ $i }}">{{ $i }}% de beca</option>
                                        @endfor
                        ...
                        <div class="row mg-t-10">
                            ...
                            <div class="col-lg-4 mg-t-20 mg-lg-t-0">
                                ...
                                <select class="form-control select2 col-lg-12" name="beca_para_bach_linea"
                                    data-placeholder="N/A">
                                    <option value="N/A" selected>N/A</option>
                                    @for ($i = 0; $i < 21; $i++) <option value="{{ $i }}">{{ $i }}% de beca</option>
                                        @endfor
                        ...
                        <div class="row mg-t-10">
                            ...
                            <div class="col-lg-4 mg-t-20 mg-lg-t-0">
                                <label class="ckbox">
                                    <input name="alcance_Municipal" value="Municipal"
                            ...
                            <div class="col-lg-4 mg-t-20 mg-lg-t-0">
                                <label class="ckbox">
                                    <input name="alcance_Estatal" value="Estatal" type="checkbox"><span>Estatal</span>
                                </label>
                            </div>

                            <div class="col-lg-4 mg-t-20 mg-lg-t-0">
                                <label class="ckbox">
                                    <input name="alcance_Nacional" value="Nacional"
                        ...
                        <div class="row" id="otro_check">
                            <div class="col-lg-12">
                                ...
                                <textarea rows="3" class="form-control" placeholder="" name="alcance_observaciones"></textarea>  
                            </div>
                        </div>
                        ...
                        <div class="form-layout-footer mg-t-30">
                            <button class="btn btn-info">Guardar convenio</button>
