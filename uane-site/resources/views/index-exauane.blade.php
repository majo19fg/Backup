...
<div id="wrapper" class="clearfix">
  ...
  <div class="main-content">
                    ...
                    <ul>
                        ...
                        <li data-description="" data-easein="Power2.easeInOut" data-easeout="default" data-index="rs-898" data-masterspeed="2000" data-param1="" data-param10="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-rotate="0" data-saveperformance="off" data-slotamount="default" data-title="Slide" data-transition="fade">
                            ...
                            <div class="tp-caption tp-resizeme text-white text-center font-raleway" 
                              ...
                              data-splitout="none" 
                              data-responsive_offset="on"
                              style="z-index: 5; white-space: nowrap; letter-spacing:1px; font-family: 'Raleway', sans-serif; font-weight:600; background:#de453b; color:#fff; border-radius:10px;"><a class="btn btn-colored btn-lg btn-flat text-white pl-20 pr-20" href="{{ route('exauane.formulario') }}">Regístrate</a> 
                            </div>
                        </li>
        ...
        <div class="section-title text-center">
          <div class="row">
            <div class="col-md-10 col-md-offset-1">
              ...
              <p>¡Actualmente somos más de 45 mil egresados en la universidad! Por eso, queremos que conozcas todos los beneficios que UANE tiene para ti. </p>
            </div>
          </div>
        </div>
        <div class="section-content">
    ...
    <!-- Section: about -->
    <section id="about" data-bg-img="images/pattern/p6.png">
      <div class="container pb-0">
        <div class="row">
          <div class="col-md-8">
            <h3 class="text-gray mt-0 mt-sm-30 mb-0">¡Llegó el momento!</h3>
            <h2 class="text-theme-colored mt-0">EXAUANE</h2>
            <p class="font-weight-600">"Generar oportunidades para desarrollar personas ejemplares comprometidas con su futuro".</p>
            <p class="mt-20">El objetivo de este programa de exalumnos es mantener el contacto con <b>UANE</b> y establecer una sinergia entre los egresados para reforzar el sentido de pertenencia y ser agentes de promoción de la <b>Misión Institucional.</b></p>
            <p>Actualmente somos una comunidad con más de 42,000 egresados. Regístrate para actualizar tu información de contacto personal y profesional. </p>
            {{-- <p class="mt-20"><img src="images/signature.png" alt=""></p> --}}
            <a href="{{ route('exauane.formulario') }}" class="btn btn-default btn-theme-colored btn-xl mt-15 mb-sm-30">¡Regístrate aquí!</a>
          </div>
          <div class="col-md-4">
            <img src="/multi/images/exauane/uane-egresados.png" alt="">
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="divider parallax layer-overlay overlay-theme-colored-9" data-bg-img="/multi/images/banners/uane-banner.jpg" data-parallax-ratio="0.7">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="col-md-7 wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.3s">
              ...
              <div class="gallery-isotope grid-2 gutter-small clearfix" data-lightbox="gallery">
                ...
                <div class="gallery-item">
                  <div class="thumb">
                    <img alt="project" src="/multi/images/exauane/1.jpg" class="img-fullwidth">
                    <div class="overlay-shade"></div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                          <a href="/multi/images/exauane/1.jpg"  data-lightbox-gallery="gallery"><i class="fa fa-picture-o"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="gallery-item">
                  <div class="thumb">
                    <img alt="project" src="/multi/images/exauane/2.jpg" class="img-fullwidth">
                    <div class="overlay-shade"></div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
                          <a href="/multi/images/exauane/2.jpg"  data-lightbox-gallery="gallery"><i class="fa fa-picture-o"></i></a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="gallery-item">
                  <div class="thumb">
                    <img alt="project" src="https://placehold.it/155x106" class="img-fullwidth">
                    <div class="overlay-shade"></div>
                    <div class="icons-holder">
                      <div class="icons-holder-inner">
                        <div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
        ...
        <div class="section-title">
          <div class="row">
            <div class="col-md-12 text-center">
              <h2 class="text-uppercase title"><span class="text-theme-colored">Letest</span> News</h2>
            </div>
          </div>
        </div>
        <div class="row">
              ...
              <div class="item">
                <article class="post clearfix maxwidth600 mb-sm-30">
                  <div class="entry-header">
                    <div class="post-thumb thumb"> <img src="https://placehold.it/330x225" alt="" class="img-responsive img-fullwidth"> </div>
