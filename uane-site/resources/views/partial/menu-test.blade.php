<!-- ########## START: LEFT PANEL ########## -->
<div class="br-logo"><a href="{{ route('home.admin') }}"><img src="/admin/images/uane-vino.png" class="img-fluid" style="max-width:180px;" alt=""></span></a></div>
<div class="br-sideleft sideleft-scrollbar">
  <label class="sidebar-label pd-x-10 mg-t-20 op-3">Navegación</label>
  <ul class="br-sideleft-menu">
    <li class="br-menu-item ">
      <a href="{{ route('home.admin') }}" class="br-menu-link {{ request()->is('mkt-user') ? 'active' : ''}}">
        <i class="menu-item-icon icon ion-ios-home-outline tx-24"></i>
        <span class="menu-item-label">Panel principal</span>
      </a><!-- br-menu-link -->
    </li><!-- br-menu-item -->
    <li class="br-menu-item">
      <a href="#" class="br-menu-link with-sub {{ request()->is('mkt-user/*') ? 'active' : ''}}">
        <i class="menu-item-icon icon ion-ios-photos-outline tx-20"></i>
        <span class="menu-item-label">Programas</span>
      </a><!-- br-menu-link -->
      <ul class="br-menu-sub">
        <li class="sub-item"><a href="{{ route('mostrar.programa') }}" class="sub-link {{ request()->is('mkt-user/ver-programas') ? 'active' : ''}}">Ver todos los programas</a></li>
        <li class="sub-item"><a href="{{ route('crear.programa') }}" class="sub-link {{ request()->is('mkt-user/crear-programas') ? 'active' : ''}}">Crear un nuevo programa</a></li>
      </ul>
    </li>
    {{-- <li class="br-menu-item">
