        ...
        <div class="col-md-4">
          <div class="widget no-border m-0">
            <ul class="list-inline font-13 sm-text-center mt-5">
              <li>
                <a class="text-white" href="{{ asset('/multi/pdf/AVISO DE PRIVACIDAD.pdf') }}">Términos y condiciones</a>
              </li>
          ...
          <div class="widget no-border pull-right sm-pull-none sm-text-center mt-10 mb-10 m-0">
            <ul class="list-inline">
              ...
              <li>
                ...
                <h5 class="font-14 m-0"> Lun a Vie 9:00 am – 9:00 pm<br>01 800 822 8263</h5>
              </li>
            </ul>
          </div>
        </div>
