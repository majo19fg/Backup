                ...
                <section>
                    ...
                    <div id="cbWrapper" class="parsley-checkbox mg-b-0">
                        ...
                        <div class="row ">
                            ...
                            <div class="col-md-3">
                                <label class="ckbox ">
                                <input value="Anuncios de prensa" {{ old('request_design') == 'Anuncios de prensa' ? 'checked' : '' }} name="request_design[]" id="sol17" type="checkbox" required>
                                <span>Anuncios de prensa</span>
                            </label>
                            </div>
                            <div class="col-md-3">
                                <label class="ckbox ">
                                <input value="Anuncios de revista" {{ old('request_design') == 'Anuncios de revista' ? 'checked' : '' }} name="request_design[]" id="sol18" type="checkbox" required>
                                <span>Anuncios de revista</span>
                            </label>
                            </div>
                            <div class="col-md-3">
                                <label class="ckbox ">
                                <input value="Anuncios espectacular" {{ old('request_design') == 'Anuncios espectacular' ? 'checked' : '' }} name="request_design[]" id="sol19" type="checkbox" required>
                                <span>Anuncios espectacular</span>
                            </label>
                            </div>
                            <div class="col-md-3">
                                <label class="ckbox ">
                            ...
                            <div class="col-md-3">
                                <label class="ckbox ">
                                <input value="Diplomas" {{ old('request_design') == 'Diplomas' ? 'checked' : '' }} name="request_design[]" id="sol21" type="checkbox" required>
                                <span>Diplomas</span>
                            </label>
                            </div>
                            ...
                            <div class="col-md-3">
                                <label class="ckbox ">
                                <input value="Animaciones" {{ old('request_design') == 'Animaciones' ? 'checked' : '' }} name="request_design[]" id="sol22" type="checkbox" required>
                            ...
                            <div class="col-md-3">
                                <label class="ckbox ">
                                <input value="GIF" {{ old('request_design') == 'GIF' ? 'checked' : '' }} name="request_design[]" id="sol23" type="checkbox" required>
                                <span>GIF</span>
                            </label>
                            </div>
                            ...
                            <div class="col-md-3">
                                <label class="ckbox ">
                                <input value="Video" {{ old('request_design') == 'Video' ? 'checked' : '' }} name="request_design[]" id="sol24" type="checkbox" required>
                                <span>Video</span>
                            </label>
                            </div>
                            ...
                            <div class="col-md-3">
                                <label class="ckbox ">
                                <input value="Edición de fotografia" {{ old('request_design') == 'Edición de fotografia' ? 'checked' : '' }} name="request_design[]" id="sol25" type="checkbox" required>
                            ...
                            <div class="col-md-3">
                                <label class="ckbox ">
                                <input value="Reconocimiento de angiguedad" {{ old('request_design') == 'Reconocimiento de angiguedad' ? 'checked' : '' }} name="request_design[]" id="sol26" type="checkbox" required>
                            ...
                            <div class="col-md-3">
                                <label class="ckbox ">
                                <input value="Tarjetas de presentación" {{ old('request_design') == 'Tarjetas de presentación' ? 'checked' : '' }} name="request_design[]" id="sol27" type="checkbox" required>
                            ...
                            <div class="col-md-3">
                                <label class="ckbox ">
                                <input value="Mailings" {{ old('request_design') == 'Mailings' ? 'checked' : '' }} name="request_design[]" id="sol28" type="checkbox" required>
                                <span>Mailings</span>
                            </label>
                            </div>
                            ...
                            <div class="col-md-3">
                                <label class="ckbox ">
                                <input value="Otro" {{ old('request_design') == 'Otro' ? 'checked' : '' }} name="request_design[]" id="sol29" type="checkbox" required>
                                <span>Otro</span>
                            </label>
                            </div>
