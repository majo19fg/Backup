    ...
    <div class="container">
        <div class="section-content">
            <div class="row">
              ...
              <div class="col-md-6">
                      <div class="gallery">
                    <div align="center"><a href="{{ asset('/multi/pdf/INFORME POR DIMENSIONES.pdf') }}"><img src="{{ asset('/multi/images/campus/Informe de dimensiones.jpg') }}" width="250px" height="250px"id=informe1 /></a>
                    </div>
                  </div>
                </div>
                </div>
