          ...
          <div class="row">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3 pb-sm-20">
              <div class="image-box-thum">
                <img class="img-fullwidth" width="263px" height="189px" alt="" src="/multi/images/programas/presencial.jpg">
              </div>
            ...
            <div class="col-xs-12 col-sm-6 col-md-3 pb-sm-20">
              <div class="image-box-thum">
                <img class="img-fullwidth" width="263px" height="189px" alt="" src="/multi/images/programas/enlinea.jpg">
              </div>
              <div class="image-box-details pt-20 pb-sm-20">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3">
              <div class="image-box-thum">
                <img class="img-fullwidth" width="263px" height="189px" alt="" src="/multi/images/programas/becas.jpg">
              </div>
              <div class="image-box-details pt-20 pb-sm-20">
                ...
                <a href="#" class="btn btn-xs btn-theme-colored">Leer más</a>
              </div>
            </div>
          </div>
        </div>
    ...
    <section id="event" class="">
      <div class="container pb-50">
        <div class="section-content">
          <div class="row">
            <div class="col-md-6">
              <h3 class="text-uppercase line-bottom mt-0 line-height-1"><i class="fa fa-calendar mr-10"></i>Próximos <span class="text-theme-color-2">eventos</span></h3>
              ...
              <div id="accordion1" class="panel-group accordion">
                ...
                <div class="panel">
                  ...
                  <div id="accordion13" class="panel-collapse collapse" role="tablist" aria-expanded="true">
                    <div class="panel-content">
                      <p>Contamos con 44 años de experiencia en educación, ofreciendo un sistema modular el cual te ayudara a enfocarte y aprovechar cada minuto de estudio.</p>
                    </div>
                  </div>
                </div>
                <div class="panel">
          ...
          <div class="row">
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.3s">
              <article class="post clearfix mb-sm-30">
                <div class="entry-header">
                  <div class="post-thumb thumb"> 
                    <img src="/multi/images/blog/PHOTOCINEMA-0066.jpg" alt="" class="img-responsive img-fullwidth"> 
                  </div>
                </div>
                <div class="entry-content p-20 pr-10 bg-white">
                  <div class="entry-meta media mt-0 no-bg no-border">
      ...
      <div class="container pt-10 pb-20">
        <div class="row">
          <div class="call-to-action">
            <div class="col-md-9">
              <h3 class="mt-5 text-white font-weight-600">¡Vive una experiencia que transforma!</h3>
            </div>
            <div class="col-md-3 text-right flip sm-text-center"> 
              <a class="btn btn-flat btn-theme-colored btn-lg mt-5" href="#" data-toggle="modal" data-target="#BSParentModal">Solicita información<i class="fa fa-angle-double-right font-16 ml-10"></i></a>  
            </div>
          </div>
        </div>
      </div>
